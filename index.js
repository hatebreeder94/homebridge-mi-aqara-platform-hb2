...
module.exports = function (homebridge) {
    ...
    Accessory = homebridge.hap.Categories;
...
function MiAqaraPlatform(log, config, api) {
    ...
    this.log.info("**************************************************************");
    this.log.info("           MiAqaraPlatform v" + packageFile.version + " By theo-69");
    this.log.info("  GitHub: https://github.com/theo-69/homebridge-mi-aqara-platform  ");
